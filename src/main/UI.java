...
public class UI {
	...
	public Font maruMonica, blackarrad, chiller;
	...
	public void drawPlayerLife() {
		...
		// Reset potitions to draw current life over.
		x = gp.tileSize/2;
		y = gp.tileSize/2;
		i = 0;
		...
		//Draw Max Mana
		x = gp.tileSize/2-5;
		y = manaStartY + iconSize + gp.tileSize /2;
		...
		for(int i = 0; i < gp.monster[1].length; i++) {
			...
			if(monster != null && monster.inCamera() ) {
				 ...
				 if(monster.hpBarOn && !monster.boss) {
			        	...
			        	double hpVarValue = oneScale * gp.monster[gp.currentMap][i].life;
				        g2.setColor(new Color(35,35,35));
				        g2.fillRect(monster.getScreenX()-1, monster.getScreenY()-16, gp.tileSize+2, 12);
				        g2.setColor(new Color(255,0,30));
				        g2.fillRect(monster.getScreenX(), monster.getScreenY()-15, (int)hpVarValue, 10);
				        ...
				        g2.setColor(new Color(255,0,30));
				        g2.fillRect(x, y, (int)hpVarValue, 20);
	...
	public void drawTitleScreen() {
            switch (titleScreenState) {
                case 0 ->                     {
                        ...
                        g2.drawString("Login", 100, y);
						y += 50;

                        g2.setFont(new Font("Arial", Font.PLAIN, 24));
                        g2.drawString("Username: " + gp.usernameInput + (gp.passwordFocused ? "_" : ""), 100, y);
						y += 50;
                        g2.drawString("Password: " + "*".repeat(gp.passwordInput.length()) + (gp.passwordFocused ? "_" : ""), 100, y);
						y += 50;

						//Loin button
                        g2.drawRect(100, y, 200, 40);
                        g2.drawString("Login", 155, y + 30);
						button1x = 100;
						button1y = y;
						//Create Account button
                        g2.drawRect(320, y, 200, 40);
                        g2.drawString("Create Account", 335, y + 30);
						button2x = 320;
						button2y = y;
                        g2.setFont(new Font("Arial", Font.PLAIN, 18));
                        g2.drawString(gp.loginMessage, 100, y+80);
                    }
                case 1 ->                     {
                        g2.setColor(new Color(0,0,0));
                        g2.fillRect(0, 0, gp.screenWidth, gp.screenHeight);
						...
						g2.setFont(new Font("Arial", Font.BOLD, 36));
						g2.drawString("Create Account", x, y);
						...
						// "Create" button
						g2.drawRect(x, y, 150, 40);
						g2.drawString("Create", x, y + 30);
						button1x = x;
						button1y = y;

						// "Back" button
						g2.drawRect(x + 170, y, 150, 40);
						g2.drawString("Back", x + 215, y+30);
						button2x = x + 170;
						button2y = y;
						g2.setFont(new Font("Arial", Font.PLAIN, 18));
						g2.drawString(gp.loginMessage, 100, 370);
...
//			currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
			...
			if(charIndex < characters.length) {
				//gp.playSE(18);   use new dialogue sound
