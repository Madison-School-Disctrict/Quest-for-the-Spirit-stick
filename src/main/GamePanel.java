...
//screen settings
    ...
    public void setInputFocus(InputFocus focus) {
        ...
        switch (inputFocus) {
            ...
            case PASSWORD ->
                inputFocus = InputFocus.CONFIRM_PASSWORD;
            case CONFIRM_PASSWORD ->
                inputFocus = InputFocus.CREATE_BUTTON;
            case CREATE_BUTTON ->
                inputFocus = InputFocus.BACK_BUTTON;
            case BACK_BUTTON ->
                inputFocus = InputFocus.USERNAME; // cycle back
            default ->
                inputFocus = InputFocus.USERNAME; // default to username
        }
    }
    ...
    public void handleDeleteAccount() {
        ...
        if (!usernameInput.isEmpty() && !passwordInput.isEmpty()) {
            ...
            if (userManager.validateUser(usernameInput, passwordInput)) {
                ...
                File saveFile1 = new File("savedata/" + usernameInput + "_save.dat");
